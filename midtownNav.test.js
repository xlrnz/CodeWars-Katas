...
const midtownNav = require("./midtownNav");

test("", () => {
  expect(midtownNav("8th Ave and W 38th St", "7th Ave and W 36th St")).toBe(
    "Walk 2 blocks south, and 1 blocks east"
  );
});

test("", () => {
  expect(midtownNav("5th Ave and W 46th St", "7th Ave and E 58th St")).toBe(
